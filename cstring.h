...
// NOTE(sushi) commenting this entire thing out because I used windows specific string functions in it
//             and we don't use it, so we might just want to get rid of it anyways 
